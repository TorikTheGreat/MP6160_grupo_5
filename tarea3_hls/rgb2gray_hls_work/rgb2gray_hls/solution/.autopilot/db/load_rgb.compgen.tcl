...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_m_axi_in \
    op interface \
    ports { m_axi_in { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_rgb_din { O 24 vector } stream_rgb_num_data_valid { I 5 vector } stream_rgb_fifo_cap { I 5 vector } stream_rgb_full_n { I 1 bit } stream_rgb_write { O 1 bit } } \
} "
}
