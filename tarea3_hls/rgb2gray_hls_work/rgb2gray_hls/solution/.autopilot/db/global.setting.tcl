...
set SourceFiles {sc {} c {../.././../rgb2gray_kernel.cpp ../../../rgb2gray_kernel.cpp}}
set SourceFlags {sc {} c {{ --std=c++14} {} --std=c++14}}
set DirectiveFile {}
set TBFiles {verilog ../../../tb_rgb2gray.cpp bc ../../../tb_rgb2gray.cpp sc ../../../tb_rgb2gray.cpp vhdl ../../../tb_rgb2gray.cpp c {} cas ../../../tb_rgb2gray.cpp}
set SpecLanguage C
