...
set name rgb2gray_top_mul_8ns_16ns_23_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rgb2gray_top_mac_muladd_13ns_8ns_23ns_23_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rgb2gray_top_mac_muladd_12ns_8ns_15ns_20_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
