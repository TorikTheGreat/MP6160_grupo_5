; ModuleID = '/home/diego/MP6160_grupo_5/tarea3_rgb2gray/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_rgb2gray_top_ir(i8* noalias nocapture nonnull readonly %image_in, i8* noalias nocapture nonnull %image_out, i32 %num_pixels) local_unnamed_addr #0 {
entry:
  %image_in_copy = alloca i8, align 512
  %image_out_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %image_in, i8* nonnull align 512 %image_in_copy, i8* nonnull %image_out, i8* nonnull align 512 %image_out_copy)
  call void @apatb_rgb2gray_top_hw(i8* %image_in_copy, i8* %image_out_copy, i32 %num_pixels)
  call void @copy_back(i8* %image_in, i8* %image_in_copy, i8* %image_out, i8* %image_out_copy)
  ret void
}
...
declare void @apatb_rgb2gray_top_hw(i8*, i8*, i32)
...
define void @rgb2gray_top_hw_stub_wrapper(i8*, i8*, i32) #4 {
entry:
  call void @copy_out(i8* null, i8* %0, i8* null, i8* %1)
  call void @rgb2gray_top_hw_stub(i8* %0, i8* %1, i32 %2)
  call void @copy_in(i8* null, i8* %0, i8* null, i8* %1)
  ret void
}

declare void @rgb2gray_top_hw_stub(i8* noalias nocapture nonnull readonly, i8* noalias nocapture nonnull, i32)
