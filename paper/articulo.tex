...
At this preliminary stage we report the functional verification of the
transform core and its effect on the coding cost of the data. Resource and
timing figures from logic synthesis (LUT, FF, DSP utilization and maximum
operating frequency) will complete the analysis.
% TODO (W2): insertar aquí la tabla/prosa de métricas de HW (LUT/FF/DSP/fmax)
% cuando esté la síntesis.
...
The next stage of the project will integrate the architecture into the HLS flow
to obtain synthesis metrics including latency, throughput, maximum operating
frequency, LUT utilization, flip-flops, DSP usage and BRAM consumption. These
metrics will be compared against conventional integer-based Walsh--Hadamard and
Discrete Cosine Transform implementations reported in the literature.
%% =====================================================================
