...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { m_axi_out_dout { I 64 vector } m_axi_out_num_data_valid { I 3 vector } m_axi_out_fifo_cap { I 3 vector } m_axi_out_empty_n { I 1 bit } m_axi_out_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { addr_out_dout { I 32 vector } addr_out_num_data_valid { I 3 vector } addr_out_fifo_cap { I 3 vector } addr_out_empty_n { I 1 bit } addr_out_read { O 1 bit } } \
} "
}
