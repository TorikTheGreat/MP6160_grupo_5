...
set C_modelArgList {
	...
	{ m_axi_out int 64 regular {fifo 0}  }
	{ addr_out int 32 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "stream_gray", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "m_axi_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "addr_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ num_pixels_dout sc_in sc_lv 32 signal 4 } 
	{ num_pixels_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ num_pixels_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ num_pixels_empty_n sc_in sc_logic 1 signal 4 } 
	{ num_pixels_read sc_out sc_logic 1 signal 4 } 
	{ addr_out_dout sc_in sc_lv 32 signal 3 } 
	{ addr_out_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ addr_out_fifo_cap sc_in sc_lv 3 signal 3 } 
	{ addr_out_empty_n sc_in sc_logic 1 signal 3 } 
	{ addr_out_read sc_out sc_logic 1 signal 3 } 
	{ m_axi_out_dout sc_in sc_lv 64 signal 2 } 
	{ m_axi_out_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ m_axi_out_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ m_axi_out_empty_n sc_in sc_logic 1 signal 2 } 
	{ m_axi_out_read sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "addr_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "addr_out", "role": "dout" }} , 
 	{ "name": "addr_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "addr_out", "role": "num_data_valid" }} , 
 	{ "name": "addr_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "addr_out", "role": "fifo_cap" }} , 
 	{ "name": "addr_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "addr_out", "role": "empty_n" }} , 
 	{ "name": "addr_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "addr_out", "role": "read" }} , 
 	{ "name": "m_axi_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "m_axi_out", "role": "dout" }} , 
 	{ "name": "m_axi_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "m_axi_out", "role": "num_data_valid" }} , 
 	{ "name": "m_axi_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "m_axi_out", "role": "fifo_cap" }} , 
 	{ "name": "m_axi_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m_axi_out", "role": "empty_n" }} , 
 	{ "name": "m_axi_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "m_axi_out", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "m_axi_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "m_axi_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "addr_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	m_axi_out { ap_fifo {  { m_axi_out_dout fifo_data_in 0 64 }  { m_axi_out_num_data_valid fifo_status_num_data_valid 0 3 }  { m_axi_out_fifo_cap fifo_update 0 3 }  { m_axi_out_empty_n fifo_status 0 1 }  { m_axi_out_read fifo_port_we 1 1 } } }
	addr_out { ap_fifo {  { addr_out_dout fifo_data_in 0 32 }  { addr_out_num_data_valid fifo_status_num_data_valid 0 3 }  { addr_out_fifo_cap fifo_update 0 3 }  { addr_out_empty_n fifo_status 0 1 }  { addr_out_read fifo_port_we 1 1 } } }
