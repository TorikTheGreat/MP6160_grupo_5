...
extern "C" __attribute__((sdx_kernel("rgb2gray_top", 0))) void rgb2gray_top(
    volatile ap_uint<32> *m_axi_in,
    volatile ap_uint<32> *m_axi_out,
    ap_uint<32> addr_in,
    ap_uint<32> addr_out,
    ap_uint<32> num_pixels);
# 9 "../rgb2gray_kernel.cpp" 2
...
extern "C" __attribute__((sdx_kernel("rgb2gray_top", 0))) void rgb2gray_top(
    ...
    ap_uint<32> addr_out,
    ap_uint<32> num_pixels) {
#line 36 "C:/Users/sfv02/Documents/TEC/Maestria/2026-2C/Alto_Nivel/Evaluaciones_Cortas/3-HLS/MP6160_grupo_5/hls/run_synthesis.tcl"
#pragma HLSDIRECTIVE TOP name=rgb2gray_top
# 119 "../rgb2gray_kernel.cpp"
