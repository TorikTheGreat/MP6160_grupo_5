...
set name rgb2gray_top_mul_8ns_14ns_21_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rgb2gray_top_mac_muladd_12ns_8ns_21ns_22_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rgb2gray_top_mac_muladd_10ns_8ns_13ns_18_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rgb2gray_top_am_addmul_18ns_22ns_23ns_45_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "cg_default_interface_gen_dc { \
    id 19 \
    name num_pixels_load \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_num_pixels_load \
    op interface \
    ports { num_pixels_load { I 32 vector } } \
} "
}
