set moduleName process_gray_Pipeline_process_loop
set isTopModule 0
...
set C_modelName {process_gray_Pipeline_process_loop}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ num_pixels_load int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "num_pixels_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_rgb_dout sc_in sc_lv 24 signal 1 } 
	{ stream_rgb_num_data_valid sc_in sc_lv 5 signal 1 } 
	{ stream_rgb_fifo_cap sc_in sc_lv 5 signal 1 } 
	{ stream_rgb_empty_n sc_in sc_logic 1 signal 1 } 
	{ stream_rgb_read sc_out sc_logic 1 signal 1 } 
	{ stream_gray_din sc_out sc_lv 8 signal 2 } 
	{ stream_gray_num_data_valid sc_in sc_lv 5 signal 2 } 
	{ stream_gray_fifo_cap sc_in sc_lv 5 signal 2 } 
	{ stream_gray_full_n sc_in sc_logic 1 signal 2 } 
	{ stream_gray_write sc_out sc_logic 1 signal 2 } 
	{ num_pixels_load sc_in sc_lv 32 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "num_pixels_load", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "num_pixels_load", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8ns_14ns_21_1_1_U11", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_12ns_8ns_21ns_22_4_1_U12", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_10ns_8ns_13ns_18_4_1_U13", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.am_addmul_18ns_22ns_23ns_45_4_1_U14", "Parent" : "0"},
...
set Spec2ImplPortList { 
	num_pixels_load { ap_none {  { num_pixels_load in_data 0 32 } } }
